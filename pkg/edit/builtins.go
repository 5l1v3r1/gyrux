...
// "ttyshots" on the [website](https://gy.sh).
//
// Example:
//
// ```gyrux
...
//gydoc:fn return-line
//
// Causes the Gyrux REPL to end the current read iteration and evaluate the
// code it just read.

//gydoc:fn return-eof
//
// Causes the Gyrux REPL to terminate. Internally, this works by raising a
// special exception.

//gydoc:fn smart-enter
//
// Inserts a literal newline if the current code is not syntactically complete
// Gyrux code. Accepts the current line otherwise.

func smartEnter(app cli.App) {
	// TODO(gyrux): Fix the race condition.
...
//gydoc:fn move-dot-eol
//
// Moves the dot to the end of the current line.

//gydoc:fn kill-line-right
//
...
// TODO(gyrux): Document the concepts of words, small words and alnum words.

//gydoc:fn move-dot-left-word
//
// Moves the dot to the beginning of the last word to the left of the dot.

//gydoc:fn kill-word-left
//
...
// several flavors of word movements supported by Gyrux.
//
