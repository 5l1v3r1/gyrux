...
import (
	...
	"github.com/entynetproject/gyrux/pkg/getopt"
	"github.com/entynetproject/gyrux/pkg/parse"
	"github.com/xiaq/persistent/hashmap"
)

//gydoc:fn complete-getopt
//
// ```gyrux
...
func completeGetopt(fm *eval.Frame, vArgs, vOpts, vArgHandlers interface{}) error {
	...
	// TODO(gyrux): Make the Config field configurable
	...
	case getopt.NewOptionOrArgument, getopt.Argument:
		...
		if argHandler != nil {
			...
			// TODO(gyrux): Notify that there is no suitable argument completer.
		}
...
// TODO(gyrux): Simplify most of the parsing below with reflection.
