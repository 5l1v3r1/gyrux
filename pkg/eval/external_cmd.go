...
var (
	// ErrExternalCmdOpts is thrown when an external command is passed Gyrux
	// options.
	//
	// TODO: Catch this kind of errors at compilation time.
	ErrExternalCmdOpts = errors.New("external commands don't accept gyrux options")
