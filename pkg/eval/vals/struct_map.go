...
// StructMap wraps the IsStructMap method, a marker to make some Gyrux
...
// be exported. Gyrux reuses the `json:"name" annotations of the fields as the
// name of the Gyrux fields in the Gyrux operations.
