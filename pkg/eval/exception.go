...
// Exception represents an gyrux exception. It is both a Value accessible to
// Gyrux, and the type of error returned by public facing evaluation
...
// nil items turned into OK's for easier access from Gyrux.
