// Framework for testing Gyrux. This file does not have a _test.go
...
func evalAndCollect(t *testing.T, ev *Evaler, texts []string) result {
	...
	for i, text := range texts {
		name := fmt.Sprintf("test%d.gy", i)
		src := NewInternalGyruxSource(true, name, text)
...
//
// TODO(gyrux): Move this into the util package.
