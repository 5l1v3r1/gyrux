...
var (
	...
	//
	// TODO(gyrux): Replace this single error type with multiple types that carry
...
// GoFn uses reflection to wrap arbitrary Go functions into Gyrux functions.
//
...
// supply the inputs.
//
// 4. Other parameters are converted using gyToGo.
//
// Return values go to the channel part of the stdout port, after being
// converted using goTocy. If the last return value has type error and is not
