...
// NewInternalGoSource returns a Source for use as a placeholder when calling Gyrux
...
func NewInternalGyruxSource(root bool, name, code string) *Source {
	return &Source{InternalGyruxSource, name, root, code}
}
...
const (
	...
	// A special value used for the Frame when calling Gyrux functions from Go.
